...
function brainCuratorInstruction(): string {
  return [
    ...
    "8. Produce a sourced curation report with: submitted proposals, auto-merged groups, contradictions, stale facts, skipped private-sensitive items, and exact source paths/ids.",
