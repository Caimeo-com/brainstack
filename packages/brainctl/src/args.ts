...
export function usage(): string {
  ...
  brainctl capabilities list|install|uninstall|doctor|test [voice] --config brainstack.yaml [--target MACHINE] [--model tiny.en|small.en|medium.en|large-v2|large-v3]
  ...
  brainctl propose --config brainstack.yaml --title TITLE --body BODY [--target-page wiki/PATH.md] [--content-file FILE] [--base-sha256 HASH|absent] [--risk low|medium|high] [--confidence 0..1] [--curator-run-id ID] [--reason TEXT] [--needs-human] [--source-ids id1,id2] [--project NAME] [--domain NAME] [--scope repo|project|global|machine|harness] [--memory-kind KIND] [--applicability TEXT] [--non-applicability TEXT] [--evidence REF] [--allow-audit-only-sources]
  brainctl proposals list|groups|clusters|show|enrich|reprocess|merge-group|auto-merge|batch-merge|approve|reject|supersede|needs-work|apply [...]
  brainctl curator status|inbox|run|install|backfill-operational [--config brainstack.yaml]
